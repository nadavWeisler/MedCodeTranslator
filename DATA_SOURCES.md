...
| LOINC (common panel subset) | Regenstrief Institute | https://loinc.org/ | LOINC license/terms apply | Attribute LOINC/Regenstrief | Review/confirm latest terms before commercial deployment | Bundled top-600 ranked observations from LOINC Top 2000+ SI list (see `data/vocabularies/sources/`) |
